...
const SvgComponent = (props: SVGProps<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      ...
      <path
        stroke="#000"
        d="M5.656 15.026h5.316v4.263H6.156a.5.5 0 0 1-.5-.5v-3.763Z"
      />
      ...
      <path
        fill={fill}
        stroke="#000"
        d="M16.184 6.605h4.815a.5.5 0 0 1 .5.5v3.763h-5.315V6.605Z"
      />
      <path stroke="#000" d="M16.184 10.816H21.5v4.263h-5.316z" />
      <path
        stroke="#000"
        d="M16.184 15.026h5.315v3.763a.5.5 0 0 1-.5.5h-4.815v-4.263Z"
      />
      <path
        fill={fill}
        stroke="#fff"
