...
const SvgComponent = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      stroke="#4A4C56"
      strokeWidth={1.5}
      d="M3.99 6.927h8.16v6.55H3.99z"
    />
    <path
      fill="#E3EBEF"
      stroke="#4A4C56"
      strokeWidth={1.5}
      d="M3.99 13.367h8.16v6.55H3.99z"
    />
    <mask id="a" fill="#fff">
    ...
    <path
      stroke="#4A4C56"
      strokeWidth={1.5}
      d="M12.043 6.927h8.16v6.55h-8.16z"
    />
    <path
      stroke="#4A4C56"
      strokeWidth={1.5}
      d="M12.043 13.367h8.16v6.55h-8.16z"
    />
    <path
      stroke="#4A4C56"
      strokeWidth={1.5}
      d="M12.043 19.806h8.16v6.55h-8.16z"
    />
    <mask id="b" fill="#fff">
    ...
    <path
      stroke="#4A4C56"
      strokeWidth={3}
      d="M19.34 6.177H28a1 1 0 0 1 1 1v7.05h-9.66v-8.05Z"
      mask="url(#b)"
    />
    <path
      stroke="#4A4C56"
      strokeWidth={1.5}
      d="M20.091 13.367h8.16v6.55h-8.16z"
    />
    <mask id="c" fill="#fff">
    ...
    <path
      stroke="#4A4C56"
      strokeWidth={3}
      d="M19.34 19.056H29v7.05a1 1 0 0 1-1 1h-8.66v-8.05Z"
      mask="url(#c)"
    />
    <path
      fill="#4A4C56"
