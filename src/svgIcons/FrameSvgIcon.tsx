...
const SvgComponent = (props: SVGProps<SVGSVGElement>) => {
  ...
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width={24} height={24} fill='none' {...props}>
      <path fill='#000' stroke='#000' d='M5.656 6.605h5.316v4.263H5.656z' />
      ...
      <path fill='#000' stroke='#000' d='M10.922 6.605h5.316v4.263h-5.316z' />
      <path stroke='#000' d='M10.922 10.816h5.316v4.263h-5.316z' />
      <path stroke='#000' d='M10.922 15.026h5.316v4.263h-5.316z' />
      <path fill='#000' stroke='#000' d='M16.184 6.605h4.815a.5.5 0 0 1 .5.5v3.763h-5.315V6.605Z' />
